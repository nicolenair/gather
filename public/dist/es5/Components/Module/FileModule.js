...
var FileModule = (function (Component) {
    function FileModule(props) {
        _classCallCheck(this, FileModule);

        _get(Object.getPrototypeOf(FileModule.prototype), "constructor", this).call(this, props);
        this.state = {
    ...
    _inherits(FileModule, Component);

    _prototypeProperties(FileModule, null, {
        handleClick: {
...
module.exports = connect(mapStateToProps)(FileModule);
